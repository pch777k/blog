...
@Controller
public class CommentAdminViewController extends ProfileCommonViewController {

    private final CommentService commentService;
    private final BlogConfiguration blogConfiguration;

    public CommentAdminViewController(PrivateMessageService privateMessageService,
    ...
    public String indexView(
        ...
        Page<Comment> commentPage = commentService.getComments(search, pageable);

        addProfileAttributes(model, user);
        paging(model, commentPage, blogConfiguration.getArticlesPageSize());
