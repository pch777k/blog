...
public class SubscriptionReaderViewController extends ProfileCommonViewController {

    private final BlogConfiguration blogConfiguration;
    private final SubscriptionService subscriptionService;

    public SubscriptionReaderViewController(PrivateMessageService privateMessageService,
    ...
    public String subscriptionsView(Model model, @AuthenticationPrincipal UserDetails userDetails,
        ...
        Page<Subscription> subscriptionPage = subscriptionService.getSubscriptionsByReaderId(user.getId(), search, pageable);
        ...
        paging(model, subscriptionPage, size);

        return "user/reader/subscription/index";
    }
